(function () {
  ...
  style.textContent = [
    ...
    '#'+uid+' .ilc-bio{font-size:0.6rem;color:#4a4a6a;line-height:1.4;width:100%;text-align:center;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}',
    '#'+uid+' .ilc-tags{display:flex;flex-wrap:wrap;gap:0.15rem;justify-content:center;margin-top:0.125rem;width:100%;overflow:hidden}',
