(function () {
  ...
  function render(data) {
    ...
    container.innerHTML = '<div class="ilc-wrap">'
      ...
      +'<svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:10px;height:10px;flex-shrink:0;display:block"><polyline points="15 18 9 12 15 6"/></svg>'
      +'</button>'
      +'<button class="ilc-arrow" id="'+nextId+'" aria-label="Next">'
      +'<svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:10px;height:10px;flex-shrink:0;display:block"><polyline points="9 18 15 12 9 6"/></svg>'
      +'</button>'
      +'</div></div>'
