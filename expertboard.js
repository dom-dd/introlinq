(function () {
  ...
  style.textContent = [
    ...
    '.ilb-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:0.875rem}',
    '@media(max-width:600px){.ilb-grid{grid-template-columns:repeat(2,1fr)}}',
    '@media(max-width:380px){.ilb-grid{grid-template-columns:1fr}}',
